        ...
        <>
            <div className="navbar-container">               
                ...
                <ul className="vanish-appear-list">
                    ...
                    <li><a href="#">Codes promo<span class="material-symbols-outlined">expand_more</span></a></li>
                    <li><a href="#">Gratuit</a></li>
                    <li><a href="#">Discussions</a></li>
                    <li><a href="#">Plus<span class="material-symbols-outlined">expand_more</span></a></li>                  
                </ul>
